...
namespace Aspiring_Keyboard
{
    public partial class MainWindow : Window
    {
        ...
        public void move_mouse_by(int x, int y)
        {
        ...
        public void LMBClick(int x = -1, int y = -1, int time = 75)
        {
            if (x == -1 || y == -1)
            {
                x = System.Windows.Forms.Cursor.Position.X;
        ...
        public void RMBClick(int x = -1, int y = -1, int time = 75)
        {
            if (x == -1 || y == -1)
            {
                x = System.Windows.Forms.Cursor.Position.X;
        ...
        public void DLMBClick(int x = -1, int y = -1, int time = 75)
        {
            if (x == -1 || y == -1)
            {
                x = System.Windows.Forms.Cursor.Position.X;
        ...
        public void LMBHold_toggle(int x = -1, int y = -1, int time = 75)
        {
            if (x == -1 || y == -1)
            {
                x = System.Windows.Forms.Cursor.Position.X;
        ...
        public void RMBHold_toggle(int x = -1, int y = -1, int time = 75)
        {
            if (x == -1 || y == -1)
            {
                x = System.Windows.Forms.Cursor.Position.X;
        ...
        public void LMBHold(int x = -1, int y = -1, int time = 75)
        {
            if (x == -1 || y == -1)
            {
                x = System.Windows.Forms.Cursor.Position.X;
        ...
        public void RMBHold(int x = -1, int y = -1, int time = 75)
        {
            if (x == -1 || y == -1)
            {
                x = System.Windows.Forms.Cursor.Position.X;

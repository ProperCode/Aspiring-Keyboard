...
namespace Aspiring_Keyboard
{
	...
	public partial class MainWindow : Window
    {
        ...
        //kl - keyboard layout
        void create_grid_alphabet_for_US_kl() //58
		{
            ...
            grid_alphabet.Add(new Grid_Symbol("/", VirtualKeyCode.OEM_2)); //not supported by all keyboard layouts
            ...
            grid_alphabet.Add(new Grid_Symbol("-", VirtualKeyCode.OEM_MINUS));  //not supported by all keyboard layouts
            //----------------------------------------------------------
		...
		//kl - keyboard layout
		void create_grid_alphabet_for_any_kl() //50
		{
			grid_alphabet = new List<Grid_Symbol>();
